    ...
    <div class="sidebar text-sm">
        <nav class="mt-2">
            <ul class="nav nav-flat nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="dashboard_payroll.html" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="advance_worker.html" class="nav-link">
                                <i class="fas fa-caret-right nav-icon"></i>
                                <p>Advance to Worker</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="contractor_bill.html" class="nav-link">
                                <i class="fas fa-caret-right nav-icon"></i>
                                <p>Contractor Bill</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="contractor.html" class="nav-link">
                                <i class="fas fa-caret-right nav-icon"></i>
                                <p>Contractor</p>
                            </a>
                        </li>
...
function setActiveMenu() {
    ...
    if (!currentPage) {
        currentPage = 'dashboard_payroll.html';
    }
    ...
    document.querySelectorAll('.nav-sidebar a.nav-link[href]').forEach(function (link) {
        ...
        if (linkPage === pageName) {
            ...
            while (parentTree) {
                ...
                let parentLink = parentItem.querySelector(':scope > .nav-link');
                ...
                parentTree = parentItem.parentElement.closest('.nav-treeview');
            }
        }
    });
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (breadcrumbLink) {
        ...
        const headerTitle = document.querySelector('.content-header .text-bold');
        if (headerTitle) {
