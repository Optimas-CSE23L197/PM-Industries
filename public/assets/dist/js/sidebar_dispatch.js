    ...
    <div class="sidebar text-sm">
        <nav class="mt-2">
            <ul class="nav nav-flat nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="dashboard_dispatch.html" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="vehicle_expense_head.html" class="nav-link">
                                <i class="fas fa-caret-right nav-icon"></i>
                                <p>Vehicle Expense Head</p>
                            </a>
                        </li>
                    </ul>
                </li>
...
function setActiveMenu() {
    ...
    if (!currentPage) {
        currentPage = 'dashboard_dispatch.html';
    }
