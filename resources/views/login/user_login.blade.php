...
<body>
    <div class="card">
        ...
        <form  action="{{ route('userVerify') }}" method="POST" id="loginForm">
            @csrf
            ...
            <div class="input">
                ...
                <input id="pwd" name="password" type="password" autocomplete="current-password" placeholder="Password"
                    required>
                <i class="fa-solid fa-eye eye" id="togglePassword" title="Show Password" aria-label="Show Password"
                    onclick="togglePwd()"></i>
            </div>
