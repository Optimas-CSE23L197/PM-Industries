    ...
    <div class="card">
        ...
        <div class="card-body print">
            ...
            <table class="table table-bordered" width="100%" border="1"
                data-tableName="@php echo 'Contractor-Master_'.date('dmHis'); @endphp" data-pageO="l"
                ...
                <thead>
                    <tr style="background-color: #343a40; color: #fff;">
                        ...
                        <th style="width: 15%; text-align: left;">Phone No.</th>
                ...
                <tbody>
                    @forelse($contractors as $i => $c)
                        <tr style="{{ $i % 2 == 0 ? 'background-color: #f8f9fa' : 'background-color: #fff' }}">
                            ...
                            <td>{{ $c['phone'] ?? '' }}</td>
                            <td>{{ $c['email'] ?? '' }}</td>
                            <td style="text-align: right">{{ number_format($c['opbal'] ?? 0, 2) }}</td>
            ...
            <div style="margin-top: 20px; border-top: 2px solid #343a40; padding-top: 10px;">
                <div style="display: flex; justify-content: space-between;">
                    <div>
                        <strong>Total Records:</strong> {{ is_array($contractors) ? count($contractors) : 0 }}
                    </div>
                    <div>
