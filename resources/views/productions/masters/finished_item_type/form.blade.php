...
@section('content')
    ...
    <section class="content mt-3">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form id="finishedItemTypeForm" method="post">
                        @csrf

                        <input type="hidden" name="code"
                               value="{{ $finishedItemType['code'] ?? 0 }}"/>
...
@push('js')
<script>
    $('#finishedItemTypeForm').submit(function (e) {
        e.preventDefault();
        var formData = new FormData(this);

        $.ajax({
            url : '/production/save-finished-item-type',
            type: 'post',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (resp) {
                ...
                if (!isError) {
                    ...
                    mtd.show_msgT(1, '/production/finished-item-type', msg, 1);
                } else {
