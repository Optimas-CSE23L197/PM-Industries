...
@section('page_title', 'Bill of Materials (BOM)')
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header py-1">
                    <label for="" class="card-title">Bill of Materials (BOM)</label>
                    <button class="btn btn-sm btn-secondary float-right ml-1"
                        onclick="location.href='{{ Route('production.printBomList') }}'">
                        <i class="fas fa-print mr-1"></i> Print
                    </button>
                    <button class="btn btn-sm btn-dark float-right"
                        onclick="location.href='{{ route('bomDetails') }}';">
                ...
                <div class="card-body">
                    <table id="depttable" class="table table-sm table-bordered">
                        <thead class="thead-light">
                            <tr>
                                <th style="width:60%">Finished Item</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type='button' class="btn btn-xs {{ $btnColor }} btn-block"
                                            onclick="mtd.show_msg(2, '{{ route('bom.stat', ['code' => $b['code'], 'actyn' => $b['activeyn']]) }}', 'Are you sure to change its status..?', 2);"
                                        >
                                            {{ $status }}
                                        </button>
                                    </td>
                                    <td class="dropdown text-center">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                            <a href="{{ route('bomDetails', ['vwedt' => 1, 'code' => $b['code']]) }}" class="dropdown-item">
                                                <div class="media"><div class="media-body"><p>View</p></div></div>
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a href="{{ route('bomDetails', ['vwedt' => 2, 'code' => $b['code']]) }}" class="dropdown-item">
