<nav class="main-header navbar navbar-expand navbar-white navbar-light py-0">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <!-- User Profile -->
        <li class="nav-item">
            <a class="nav-link" data-toggle="tooltip" data-placement="top" data-html="true" title="Logged in as Admin">
                <i class="fas fa-user"></i>
            </a>
        </li>
        <!-- Logout -->
        <li class="nav-item">
            <a class="nav-link" href="{{ Route('logout') }}" role="button" data-toggle="tooltip" data-placement="top" title="Logout">
